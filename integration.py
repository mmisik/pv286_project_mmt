...
class TestPanbyteIntegration(unittest.TestCase):
    def test_echo_bytes_to_bytes(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "bytes", "-t", "bytes"]
    ...
    def test_echo_hex_to_bytes(self):
        input_str = "74657374"
        expected_output_str = "test"
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "hex", "-t", "bytes"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_echo_bytes_to_hex(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "bytes", "-t", "hex"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_echo_hex_to_int_big(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "int", "--from-options=big", "-t", "hex"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_echo_hex_to_int_little(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "hex", "-t", "int", "--to-options=little"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_echo_bits_to_bytes(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "bits", "-t", "bytes"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_echo_bits_left_to_bytes(self):
        ...
        expected_output_str = "OK"
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "bits", "--from-options=left", "-t", "bytes"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_echo_bits_right_to_hex(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "bits", "--from-options=right", "-t", "hex"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_echo_bytes_to_bits(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "bytes", "-t", "bits"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_hex_to_bits_conversion(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "hex", "-t", "bits"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_bits_to_hex_conversion(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "bits", "-t", "hex"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_int_to_bits_conversion(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "int", "-t", "bits"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_bits_to_int_conversion(self):
        ...
        expected_output_str = "1234567890"
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "bits", "-t", "int"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_hex_to_int_conversion(self):
        ...
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "hex", "-t", "int"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
    ...
    def test_int_to_hex_conversion(self):
        ...
        expected_output_str = "DEADBEEF"
        cmd = ["echo", input_str, "|", "java", "-jar", "target/panbyte.jar", "-f", "int", "-t", "hex"]
        output = subprocess.check_output(" ".join(cmd), shell=True).decode().strip()
        self.assertEqual(output, expected_output_str)
