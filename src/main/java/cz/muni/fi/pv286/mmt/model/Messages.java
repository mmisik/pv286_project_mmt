...
public final class Messages {
    ...
    public static final String FILE_SET_DUPLICITY = "File set duplicity";
    public static final String CANT_READ_FILE = "Cannot read file";
    public static final String CANT_WRITE_FILE = "Cannot write file";
    public static final String FORMAT_SET_DUPLICITY = "Format set duplicity";
